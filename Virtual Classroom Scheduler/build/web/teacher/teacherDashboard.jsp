...
<body>
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            ...
            <ul class="nav-links">
                <li>
                    <a href="teacher-dashboard.jsp" class="active">
        ...
        <div class="main-content">
                            ...
                            <%
                                ...
                                if (schedules != null) {
                                    ...
                                    for (ClassSchedule s : schedules) {
                                        // This is a simplified check - you'd want to compare dates properly
                                        upcomingClasses++;
                                    }
                                }
                            %>
            ...
            <div class="quick-actions">
                ...
                <div class="actions-grid">
                    <a href="${pageContext.request.contextPath}/schedules/create" class="action-btn">
                        <i class="fas fa-plus-circle"></i>
                        <span>Create Schedule</span>
                    </a>
                    
                    <a href="attendance.jsp" class="action-btn">
                        <i class="fas fa-clipboard-check"></i>
                        <span>Mark Attendance</span>
                    </a>
                    
                    <a href="grades.jsp" class="action-btn">
                        <i class="fas fa-edit"></i>
                        <span>Enter Grades</span>
                    </a>
                    
                    <a href="students.jsp" class="action-btn">
                        <i class="fas fa-users"></i>
            ...
            <div class="upcoming-classes">
                ...
                <% 
                    ...
                    boolean hasUpcomingClasses = schedules != null && !schedules.isEmpty();
                %>
                
                <% if (hasUpcomingClasses) { %>
                    <ul class="class-list">
                        <% 
                            // Display first 3 classes as upcoming (simplified)
                            int count = 0;
                            for (ClassSchedule s : schedules) {
                                if (count >= 3) break;
                        %>
