...
<%
    ...
    record2.put("id", "2"); record2.put("className", "Physics 201"); record2.put("date", "2023-12-01"); 
    record2.put("present", "28"); record2.put("absent", "2"); record2.put("total", "30"); record2.put("percentage", "93%");
        ...
        <div class="main-content">
            ...
            <div class="stats-container">
                <div class="stat-card">
                    ...
                    <div class="stat-info"><h3>92%</h3><p>Overall Attendance</p></div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon present"><i class="fas fa-user-check"></i></div>
                    <div class="stat-info"><h3>1,150</h3><p>Present Today</p></div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon absent"><i class="fas fa-user-times"></i></div>
                    <div class="stat-info"><h3>85</h3><p>Absent Today</p></div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon classes"><i class="fas fa-chalkboard-teacher"></i></div>
                    <div class="stat-info"><h3>45</h3><p>Classes Today</p></div>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="export-attendance.jsp?id=<%= record.get("id") %>" class="btn btn-primary btn-sm">
